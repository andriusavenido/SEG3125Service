...
const Cart: React.FC = () => {
    ...
    return (
        <div className='container mt-5 '>
            <div className='row'>
                <div className="col-12 col-md-8 bg-secondary text-light p-3 mb-3 mb-md-0 p-3">
                ...
                <div className='col-4 bg-info text-light p-3 d-flex flex-column justify-content-between'>
